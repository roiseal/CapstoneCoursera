...
========================================================
author: Alla Roisenberg

This presentation will briefly but comprehensively pitch an [application](https://roiseal.shinyapps.io/cdsc/) for predicting the next word.
...
![SwiftKey & Coursera Logo](logos.png)
...
* The next word prediction app is hosted on shinyapps.io: [https://roiseal.shinyapps.io/cdsc](https://roiseal.shinyapps.io/cdsc)

* The whole code of this application, as well as all the milestone report, related scripts, this presentation  etc. can be found in this GitHub repo: [https://github.com/roiseal/CapstoneCoursera](https://github.com/roiseal/CapstoneCoursera)

* This pitch deck is located here: [http://rpubs.com/roiseal/cdsc](http://rpubs.com/roiseal/cdsc)
